...
<big>三、部件编码表</big>
    ...
    20 山  21 丄止歺齿  22 刂业  23 非  24 卜⺌（党字头中）25 冂巾   26 虫   27 且（直字底）  28 贝貝    29 ⻊足
    ...
    90 夕夂攵（祭字头边）91 钅釒金  92 禾 93 舟彡 94 矢缶 95 鬼 96 舌 97 片身臼（段舆盥字边）98 鱼魚  99 鸟鳥（鸟鳥字头）
    60 方  61立啇商（旁字头中）62 礻 63 衤 64（兴学學字头中）65 心必  66 文六亦变字头 67 手毛气 68 米（敝字旁）69 火灬
    00（标点符号）01 彐（录尹字头）02 出爿  03 艮（即字旁）04 习  05 乜巜巛  06 毌毋母  07 尸  08 疋癶  09（数字序号）

...
<big>按键说明</big>
    ...
    输入速度快，字词重码少，适合编写长篇文章、会议速记等工作，符合华人书写习惯，避免“提笔忘字”的电脑病。
    ...
    按键“+（加号）”首先第一个输入时为+号，若跟随在编码后输入则切换到候选字选词模式，继续输入0~9选择列出的字词；
...
<big>三、部件编码表</big>
    ...
    10 扌 11 二王  12 十丅丁木朩  13 厂丆歹豕（有字头）  14 石   15 七丂匚匸   16雨  17 艹⺿卄  18 廿甘  19 土士走
    20 山    21 丄止歺   22 刂业   23 非   24 卜⺌  25 冂巾    26 虫    27 且（直字底）  28 贝貝    29 ⻊足
    30 饣飠食  31 牜牛   32 亻   33 彳⺁  34 八人入乂  35 九几儿匕勹角（然字边） 36 月   37 ⺮竹   38 犭  39 爫豸
    40 讠    41 冫亠方   42 门   43 丷（关卷字头中）  44 氵   45 冖    46 宀    47 广   48 疒   49 忄
    50 马馬   51 刁（那字边）52 了阝卩丩凵   53 刀力乃   54 又厶廴（予字头） 55 纟糹  56 幺   57 弓  58 子孑  59 女
    
    笔画数较多、不太常用、结构复杂的边旁部首和部件（共46个）：
    
    70 其    71 丰耒  72 耳   73（邦字边） 74 西覀   75 酉   76 井（冓字头） 77 车車   78 镸髟    79 牙
    80 口    81 日曰    82 目   83 田由甲申   84 罒四皿    85 骨     86 門鬥    87 虍    88（无）   89（无）
    90 夕夂攵（祭字头）91 钅釒金  92 禾  93 舟彡  94 矢  95 鬼  96 舌  97 片身臼（段舆盥字边） 98 鱼魚  99 鸟鳥
    60 立（旁字头中）61 訁言   62 礻  63 衤 64 兴字头  65 心必  66 文六亦变字头  67 手毛气  68 米（敝字旁）69 火灬
    00（标点符号）01 彐（录尹字头）02 爿 03 艮（即字旁）04 习羽  05 乜彑毌毋母  06 巜巛  07 尸  08 癶  09（数字序号）
    ...
    只需一个编码，即 0~9 所代表的最常用汉字分别是：1 一，2 国，3 的，4 为，5 能，6 这，7 要，8 是，9 和，0 那。
...
<big>    六、易错易混汉字</big>
    ...
    5、"里、垂、重"等最后三笔形成的"土"形结构，因其笔顺是先一竖再横，与"土"字旁不同，故需按其笔顺取笔画编码（”里“取”甲“部件）。
    6、"衰、蓑"等字中间的"口"形结构，按笔顺应先写"口"中间的一横，打乱了"口"字的笔顺，故不按"口"字部件取码，需取其笔画编码2511。
    7、“冒、帽”上面不是“日”字，而是丨乛一一，这两横不连接到旁边，即2511。
    8、”有、育、膏“的下面不是”月“，而是先一竖，丨乛一一，即2511（简码25）。

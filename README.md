...
<big> 二、部件输入方法（精简码）</big>
    ...
    91 广    92 忄（心）    93 火（灬）    94 氵    95 讠（訁）    96 方    97 宀    98 疒    99 礻    90 衤
...
<big>三、智能渐进方式</big>
    ...
    10 髟    12 其    13 歹    14 覀（西）    17 耳
    20 骨    21 虍    24 肖字头（党字头）    25 黑    27 門
    30 饣    31 牜（牛生）    32 臼    33 舟    34 爫（豸受字头）    35 角（）    36 身    37 舌    38 矢    39 鸟（鳥）
    40 气    41 立（旁字头）    42 门    43 米    44 学學字头
    52 子    54 癶    59 鬼
    60 革（廿）     67 走（土士）

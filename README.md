...
<big>三、部件编码表</big>
    ...
    40 讠訁言  41 冫亠（京字头中） 42 门  43 丷（关卷字头中） 44 氵  45 冖   46 宀   47 广鹿   48 疒   49 忄
    50 马馬   51 刁（那字边）52 了阝卩丩凵  53 刀力乃   54 又厶廴予（予字头）55 纟糹 56 幺乡  57 弓  58 孑子  59 女
    
    笔画数较多、不太常用、结构复杂的边旁部首和部件（共48个）：
    
    70 其    71 丰耒  72 耳臣   73（邦字边） 74 覀西   75 酉   76 井（冓字头） 77 车車   78 镸長髟  79 牙來
    80 口    81 日曰    82 目   83 田由甲申   84 罒四皿   85 骨黽    86 黑    87 歺虍尗鹵   88 門鬥    89 婁
    90 夕夂攵夊（祭字边头）91 钅釒金 92 禾 93 彡舟 94 矢缶 95 鬼 96 失舌 97 片身臼（段舆盥字边）98 鱼魚 99 鸟鳥（鸟鳥字头）
    60 方  61 立（旁商字头中）62 礻 63 衤 64（兴学學字头中）65 心必  66 文六亦变字头 67 手毛气 68 米（敝字旁）69 火灬
    00（标点符号）01 彐（录尹字头）02 出爿  03 艮（即字旁）04 习 05 乜巜巛 06 毌毋母 07 尸（叚字旁）08 疋癶 09（数字序号）

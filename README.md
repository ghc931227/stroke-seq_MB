...
<big> 二、部件输入方法（精简码）</big>
    ...
    61 王    62 木（朩）    63 石    64 艹    65 车（車）    66 扌    67 土（走）    68 酉    69 雨    60 廿（革）
    71 日    72 目    73 山    74 田    75 口    76 ⻊（足）    77 虫    78 贝（貝）    79 罒（四）    70 巾
    81 钅（釒）    82 亻    83 禾    84 人（飠）    85 月    86 ⺮    87 犭    88 彳    89 鱼（魚）    80 夂 （攵）
    91 广    92 忄（心）    93 火（灬）    94 氵    95 讠（訁）    96 方    97 宀    98 疒    99 礻（示）    90 衤
    01 尸    03 阝（卩）    03 女    04 又    05 纟（糹）     06 马 （馬）   07 厶    08 弓
...
<big>三、智能渐进方式</big>
    ...
    10 髟    12 其    13 歹    15 覀    17 耳
    20 骨    25 黑    27 門
    30 饣    31 牜    32 臼    33 舟    34 豸    35 角（）    37 舌    38 矢
    41 立    42 门    43 米
    52 子
    60 革（廿）     67 走（土）
...
<big>    六、易错易混汉字</big>
    ...
    13、”育、膏“的下面不是”月“，而是先一竖丨乛一一，即2511。

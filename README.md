...
<big>三、部件编码表</big>
    ...
    10 镸髟  11   12  其    13  厂歹豕    14 西覀    15 酉   16 丰耒（邦字边）  17 冓字头  18（无）  19（无）
    20 骨    21 止歺   22 刂业  23 虍    24 卜非    25 巾（有字底）  26 門鬥    27 且（直字底）  28（无）  28（无）
    ...
    50 巜巛   51 巳    52 阝卩  53 刀力    54 又厶癶廴（予字头）  55 彑毌母   56 羽   57 艮（即字旁） 58 爿  59（无）
